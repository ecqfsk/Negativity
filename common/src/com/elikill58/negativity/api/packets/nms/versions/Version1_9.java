...
public class Version1_9 extends NamedVersion {
	...
	public Version1_9() {
		...
		for (Client type : Arrays.asList(Client.TELEPORT_ACCEPT, Client.TAB_COMPLETE, Client.CHAT, Client.CLIENT_COMMAND, Client.SETTINGS, Client.PONG, Client.ENCHANT_ITEM,
				Client.WINDOW_CLICK, Client.CLOSE_WINDOW, Client.CUSTOM_PAYLOAD, Client.USE_ENTITY, Client.KEEP_ALIVE, Client.POSITION, Client.POSITION_LOOK, Client.LOOK, Client.FLYING,
				Client.VEHICLE_MOVE, Client.BOAT_MOVE, Client.ABILITIES, Client.BLOCK_DIG, Client.ENTITY_ACTION, Client.STEER_VEHICLE, Client.RESOURCE_PACK_STATUS, Client.HELD_ITEM_SLOT,
				Client.SET_CREATIVE_SLOT, Client.UPDATE_SIGN, Client.ARM_ANIMATION, Client.SPECTATE, Client.BLOCK_PLACE, Client.USE_ITEM)) {
			playIn.put(i++, type);
		}
		i = 0;
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.SPAWN_ENTITY_WEATHER, Server.SPAWN_ENTITY_LIVING, Server.SPAWN_ENTITY_PAINTING,
				...
				Server.UNLOAD_CHUNK, Server.GAME_STATE_CHANGE, Server.KEEP_ALIVE, Server.MAP_CHUNK, Server.WORLD_EVENT, Server.WORLD_PARTICLES, Server.LOGIN, Server.MAP,
				Server.REL_ENTITY_MOVE, Server.REL_ENTITY_MOVE_LOOK, Server.REL_ENTITY_LOOK, Server.ENTITY, Server.VEHICLE_MOVE, Server.OPEN_SIGN_EDITOR, Server.ABILITIES,
				Server.COMBAT_EVENT, Server.PLAYER_INFO, Server.POSITION, Server.BED, Server.ENTITY_DESTROY, Server.REMOVE_ENTITY_EFFECT, Server.RESOURCE_PACK_SEND, Server.RESPAWN,
				Server.ENTITY_HEAD_ROTATION, Server.WORLD_BORDER, Server.CAMERA, Server.HELD_ITEM_SLOT, Server.SCOREBOARD_DISPLAY_OBJECTIVE, Server.ENTITY_METADATA, Server.ATTACH_ENTITY,
				...
				Server.SCOREBOARD_SCORE, Server.SPAWN_POSITION, Server.UPDATE_TIME, Server.TITLE, Server.UPDATE_SIGN, Server.NAMED_SOUND_EFFECT, Server.PLAYER_LIST_HEADER_FOOTER,
				Server.COLLECT, Server.ENTITY_TELEPORT, Server.UPDATE_ATTRIBUTES, Server.ENTITY_EFFECT)) {
			playOut.put(i++, type);
		}

		entityTypes.put(1, EntityType.ITEM_FRAME);
		...
		entityTypes.put(10, EntityType.SPECTRAL_ARROW);
