...
public class Version1_21_08 extends NamedVersion {

	public Version1_21_08() {
		super("1.21.8");
		int i = 0;
		...
		i = 0;
		for (Server type : Arrays.asList(Server.BUNDLE, Server.SPAWN_ENTITY, Server.ANIMATION, Server.STATISTIC, Server.BLOCK_CHANGED_ACK, Server.BLOCK_BREAK_ANIMATION, Server.TILE_ENTITY_DATA,
