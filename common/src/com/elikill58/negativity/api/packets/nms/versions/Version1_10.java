...
public class Version1_10 extends NamedVersion {
	...
	public Version1_10() {
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.SPAWN_ENTITY_WEATHER, Server.SPAWN_ENTITY_LIVING, Server.SPAWN_ENTITY_PAINTING,
				...
				Server.SCOREBOARD_SCORE, Server.SPAWN_POSITION, Server.UPDATE_TIME, Server.TITLE, Server.NAMED_SOUND_EFFECT, Server.PLAYER_LIST_HEADER_FOOTER, Server.COLLECT,
				Server.ENTITY_TELEPORT, Server.UPDATE_ATTRIBUTES, Server.ENTITY_EFFECT)) {
			playOut.put(i++, type);
		}
