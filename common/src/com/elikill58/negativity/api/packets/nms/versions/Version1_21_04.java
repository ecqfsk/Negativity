...
public class Version1_21_04 extends NamedVersion {
	...
	public Version1_21_04() {
		...
		for (Client type : Arrays.asList(Client.TELEPORT_ACCEPT, Client.TILE_NBT_QUERY, Client.BUNDLE_ITEM_SELECTED, Client.DIFFICULTY_CHANGE, Client.CHAT_ACK, Client.CHAT_COMMAND,
				...
				Client.SET_CREATIVE_SLOT, Client.SET_JIGSAW, Client.STRUCT, Client.UPDATE_SIGN, Client.ARM_ANIMATION, Client.SPECTATE, Client.TELEPORT_TO_ENTITY, Client.USE_ITEM,
				Client.BLOCK_PLACE)) {
			playIn.put(i++, type);
		}
		i = 0;
		for (Server type : Arrays.asList(Server.BUNDLE, Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.ANIMATION, Server.STATISTIC, Server.BLOCK_CHANGED_ACK, Server.BLOCK_BREAK_ANIMATION, Server.TILE_ENTITY_DATA,
				Server.BLOCK_ACTION, Server.BLOCK_CHANGE, Server.BOSS, Server.SERVER_DIFFICULTY, Server.CHUNK_BATCH_FINISHED, Server.CHUNK_BATCH_STARTED, Server.CHUNK_BIOMES, Server.CLEAR_TITLE,
				Server.TAB_COMPLETE, Server.COMMANDS, Server.CLOSE_WINDOW, Server.WINDOW_ITEMS, Server.WINDOW_DATA, Server.SET_SLOT, Server.COOKIE_REQUEST, Server.SET_COOLDOWN,
				Server.CHAT_CUSTOM_COMPLETION, Server.CUSTOM_PAYLOAD, Server.DAMAGE_EVENT, Server.DEBUG_SAMPLE, Server.CHAT_DELETE, Server.KICK_DISCONNECT, Server.CHAT_DISGUISED, Server.ENTITY_STATUS,
				Server.ENTITY_POSITION_SYNC, Server.EXPLOSION, Server.UNLOAD_CHUNK, Server.GAME_STATE_CHANGE, Server.OPEN_WINDOW_HORSE, Server.HURT_ANIMATION, Server.INITIALIZE_BORDER,
				Server.KEEP_ALIVE, Server.LEVEL_CHUNK_LIGHT, Server.WORLD_EVENT, Server.WORLD_PARTICLES, Server.LIGHT_UPDATE, Server.LOGIN, Server.MAP, Server.OPEN_WINDOW_MERCHANT,
				Server.REL_ENTITY_MOVE, Server.REL_ENTITY_MOVE_LOOK, Server.MOVE_MINECART_ALONG_TRACK, Server.REL_ENTITY_LOOK, Server.VEHICLE_MOVE, Server.OPEN_BOOK, Server.OPEN_WINDOW,
				Server.OPEN_SIGN_EDITOR, Server.PING, Server.PONG, Server.RECIPE_PLACE_GHOST, Server.ABILITIES, Server.CHAT, Server.COMBAT_END_EVENT, Server.COMBAT_ENTER_EVENT,
				Server.COMBAT_KILL_EVENT, Server.PLAYER_INFO_REMOVE, Server.PLAYER_INFO_UPDATE, Server.LOOK_AT, Server.POSITION, Server.ROTATION, Server.RECIPE_BOOK_ADD, Server.RECIPE_BOOK_REMOVE,
				Server.RECIPE_BOOK_SETTINGS, Server.REMOVE_ENTITIES, Server.REMOVE_ENTITY_EFFECT, Server.SCOREBOARD_RESET, Server.RESOURCE_PACK_POP, Server.RESOURCE_PACK_SEND, Server.RESPAWN,
				Server.ENTITY_HEAD_ROTATION, Server.MULTI_BLOCK_CHANGE, Server.SELECT_ADVANCEMENT_TAB, Server.SERVER_DATA, Server.SET_ACTION_BAR_TEXT, Server.SET_BORDER_CENTER,
				...
				Server.SET_CHUNK_CACHE_RADIUS, Server.SET_CURSOR_ITEM, Server.SPAWN_POSITION, Server.SCOREBOARD_DISPLAY_OBJECTIVE, Server.ENTITY_METADATA, Server.ATTACH_ENTITY, Server.ENTITY_VELOCITY,
				Server.ENTITY_EQUIPMENT, Server.EXPERIENCE, Server.UPDATE_HEALTH, Server.HELD_ITEM_SLOT, Server.SCOREBOARD_OBJECTIVE, Server.MOUNT, Server.SET_PLAYER_INVENTORY, Server.SCOREBOARD_TEAM,
				...
				Server.TAG_UPDATE, Server.PROJECTILE_POWER, Server.CUSTOM_REPORT_DETAILS, Server.SERVER_LINKS)) {
			playOut.put(i++, type);
		}
		i = 0;
