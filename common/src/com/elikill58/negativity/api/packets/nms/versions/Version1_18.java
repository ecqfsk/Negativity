...
public class Version1_18 extends NamedVersion {
	...
	public Version1_18() {
		...
		for (Server type : Arrays.asList(Server.SPAWN_ENTITY, Server.SPAWN_ENTITY_EXPERIENCE_ORB, Server.SPAWN_ENTITY_LIVING, Server.SPAWN_ENTITY_PAINTING, Server.SPAWN_PLAYER,
				Server.ADD_VIBRATION_SIGNAL, Server.ANIMATION, Server.STATISTIC, Server.BLOCK_CHANGED_ACK, Server.BLOCK_BREAK_ANIMATION, Server.TILE_ENTITY_DATA, Server.BLOCK_ACTION,
				...
				Server.SET_TITLE_TEXT, Server.SET_TITLE_ANIMATION, Server.ENTITY_SOUND, Server.NAMED_SOUND_EFFECT, Server.STOP_SOUND, Server.PLAYER_LIST_HEADER_FOOTER, Server.NBT_QUERY,
				Server.COLLECT, Server.ENTITY_TELEPORT, Server.ADVANCEMENTS, Server.UPDATE_ATTRIBUTES, Server.ENTITY_EFFECT, Server.RECIPE_UPDATE, Server.TAGS)) {
			playOut.put(i++, type);
		}
		i = 0;
		...
		loadPostFlattening("/versions/v1_18/");
